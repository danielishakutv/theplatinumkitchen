...
export async function SiteHeader() {
  ...
  // Staff browsing the storefront still get their console notifications, and
  // their order notifications deep-link into the admin console.
  const notificationsHref = isStaff
    ? "/admin/notifications"
    : "/account/notifications";
  const orderHrefBase = isStaff ? "/admin/orders" : "/order";
